...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-RiA3iJd0.mjs";
...
import { u as useWebhooks } from "./useWebhooks-zP0GkxQH.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-lwDGPldA.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-Bm_G78-a.mjs.map
