...
const useWebhooks = require("./useWebhooks-69wwIYhj.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable--vX6XT3K.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage--bIEbepS.js.map
