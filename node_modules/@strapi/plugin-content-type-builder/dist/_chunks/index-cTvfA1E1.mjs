...
const ListView$1 = lazy(() => import("./ListView-dsCco7pK.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-dsCco7pK.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-cTvfA1E1.mjs.map
